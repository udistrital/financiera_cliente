...
angular.module('financieraClienteApp')
    .controller('AboutCtrl', function(financieraRequest, $timeout, $http, $scope, configuracionRequest, $rootScope, agoraRequest, $sessionStorage) {
        $scope.OrdenPago = {};
        $scope.SenData = {};
        $scope.SenData.Usuario = { 'Id': 1 };
        $scope.fecha_hora = $sessionStorage.expires_at;
        console.log($scope.fecha_hora);
        //Ordenes
