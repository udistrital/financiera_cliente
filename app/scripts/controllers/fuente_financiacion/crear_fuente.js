...
.controller('crearFuenteCtrl', function ($scope,financieraRequest,oikosRequest) {
...
self.dependencia=['1','2'];
      ...
      self.gridOptionsfuente = {
          ...
          columnDefs: [
                ...
                { field: 'Valor',   cellFilter: 'currency',cellTemplate:'<span>{{Valor | currency}}</span>' },
            ...
            self.gridOptionsapropiacion = {
                ...
                columnDefs: [
                      ...
                      { name:'Vigencia', field: 'Vigencia',width: '15%'},
...
self.crear_fuente= function(){
  ...
  swal("Error", "El Monto Ingrasado Supera el Valor de la Fuente de Financiación", "success");
  }
  else{
