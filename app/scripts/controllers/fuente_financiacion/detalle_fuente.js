 ...
 */
 angular.module('financieraClienteApp').controller('detalleFuenteCtrl', function($window, $timeout, $scope, $translate, financieraMidRequest, financieraRequest, oikosRequest, coreRequest) {
     ...
     self.gridOptionCDP.onRegisterApi = function(gridApi) {
       ...
       gridApi.selection.on.rowSelectionChanged($scope, function(row) {
         ...
         self.cambiar_rubro = function(){
           ...
           financieraMidRequest.get('disponibilidad/ListaDisponibilidades/' + parseInt(self.Vigencia) + "/", 'limit=-1&UnidadEjecutora='+parseInt(1)+'&query=DisponibilidadApropiacion.FuenteFinanciamiento.Id:' + parseInt(self.fuente)).then(function(response) {
           ...
           financieraMidRequest.get('registro_presupuestal/ListaRp/' + parseInt(self.Vigencia) + "/", 'limit=-1&UnidadEjecutora='+parseInt(1)+'&query=RegistroPresupuestalDisponibilidadApropiacion.DisponibilidadApropiacion.FuenteFinanciamiento.Id:' + parseInt(self.fuente)).then(function(response) {
