...
angular.module('financieraClienteApp')
    .controller('menuCtrl', function($location, $http, $scope, token_service, notificacion, $translate, $route, $mdSidenav) {
        ...
        $scope.menu_service = [];
        $scope.menu_service_old = [{ //CDP
                "Id": 1,
                "Nombre": "CDP",
                "Url": "",
                "Opciones": [{ //solicitud_consulta de CDP
                        "Id": 1,
            ...
            { //Ordenes de pago
                ...
                "Url": "",
                "Opciones": [{ //Consultar Ordenes de pago
                        "Id": 51,
        ...
        /*$scope.notificacion.get_crud('notificacion', $.param({
            ...
            .then(function(response) {
                notificacion.log = response.data;
