...
var text_es = {
  ...
  CARNET: "Carnet",
  CATEGORIA: "Categoria",
  CATEGORIAS_TIPOS: "Categorias y Tipos",
  CDP: "CDP",
  CDP_NUMERO: "CDP No.",
  CHEQUE: "Cheque",
  ...
  DESEA_CREAR_CATEGORIA: "Desea crear una nueva categoria?",
  ...
  E_04566: "No es posible realizar la actualización sobre un concepto ya utilizado",
  E_22001: "La longitud de uno de los valores ingresados excede al maximo permitido",
  E_23503: "No se encontraron algunos campos",
  E_23505: "Ya existe un registro con uno de los parametros únicos ingresados",
  ...
  E_C15973: "El Registro a actualizarse no concuerda con el Id esperado",
  E_A12: "Valor a anular supera el saldo de la disponibilidad en el rubro seleccionado",
  E_HO_CONC_TITAN: "Error al obtener conceptos de Titan",
  ...
  E_C92011: "Un concepto no puede ser creado dentro de otro concepto, únicamente dentro de una carpeta",
  E_TRANS_01: "Error en la estructura de parametros de entrada",
  E_OP_E_ESTADO: "Error al intentar registrar estado de orden de pago",
  OPM_S001: "Homologacion Exitosa",
  OPM_E001: "Concepto de titan no cuenta con conceptos homologados de Kronos",
  OPM_E002: "El valor de la Orden de pago supera el saldo del registro presupuestal",
  OPM_E003: "No hay registro presupuestal asociado al contrato",
  OPM_E004: "No hay conceptos honologados, el otro que teniamos es error de datos",
  FACTURA: "Factura",
  FACULTAD: "Facultad",
  FECHA: "Fecha",
  ...
  MSN_TAMANO_MAX: "Sobrepasa el tamaño maximo",
  ...
  SELECCIONAR_CATEGORIA: "Seleccione la Categoria",
