...
angular.module('financieraClienteApp')
  .directive('verConcepto', function(financieraRequest,presupuestoRequest) {
    return {
      restrict: 'E',
      scope: {
        codigoconcepto: '=?',
      ...
      controller: function($scope) {
        ...
        self.cargar_concepto = function() {
          presupuestoRequest.get('concepto', $.param({
            ...
            presupuestoRequest.get('afectacion_concepto', $.param({
            ...
            presupuestoRequest.get('concepto_cuenta_contable', $.param({
              query: "Concepto:" + self.v_concepto.Id
            })).then(function(response) {
              ...
              presupuestoRequest.get("concepto_detalle_tipo_transaccion", $.param({
